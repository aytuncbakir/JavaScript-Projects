...
class App {
  ...
  _renderWorkout(workout) {
    ...
    <button class="workout__button-delete">X</button>
  ...
  _moveToPopup(e) {
    ...
    if (e.target.textContent === 'X') {
      ...
      this.#workouts.filter(workout => workout.id !== id);
  ...
  _convertStringDataToWorkoutObject(data) {
    let workout;
    data.forEach(work => {
